...
Please see [installation_guide](https://github.com/fernandaroeg/darknet_ros_CUDA11.7enabled/blob/master/installation_guide.md) for installation and configuration instructions. 
